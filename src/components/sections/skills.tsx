...
export function SkillsSection() {
  ...
  return (
    <section id="skills" className="section-padding bg-white dark:bg-[#050505] relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute top-1/2 left-1/4 w-96 h-96 bg-primary-500/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="mt-24 grid grid-cols-3 md:grid-cols-6 gap-6 grayscale opacity-30 hover:grayscale-0 hover:opacity-100 transition-all duration-700 cursor-default">
           {skills.slice(0, 12).map((skill, index) => (
             ...
             >
                <motion.div 
                  className="w-12 h-12 rounded-xl bg-white dark:bg-white/5 border border-white/10 flex items-center justify-center text-xl font-bold group-hover:scale-110 transition-transform shadow-lg"
